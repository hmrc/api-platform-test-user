...
object Services {
  ...
  val all = Seq(
    ...
    Service(ServiceKey.MODERNISATION_OF_AUTHORISATIONS, "Modernisation of Authorisations", Seq(ORGANISATION)),
    Service(ServiceKey.PILLAR_2, "Pillar 2", Seq(ORGANISATION, AGENT))
  )
}
